<?php
namespace shellpress\v1_2_8\src\Components\External;
...
class AutoloadingHandler extends IComponent {
	...
	protected function onSetUp() {
		...
		if ( ! class_exists( 'shellpress\v1_2_8\lib\Psr4Autoloader\Psr4AutoloaderClass' ) ) {
		...
		$this->psr4Autoloader->addNamespace( 'shellpress\v1_2_8', $this->s()->getShellPressDir() );
