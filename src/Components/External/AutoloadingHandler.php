<?php
namespace shellpress\v1_3_81\src\Components\External;
...
use shellpress\v1_3_81\src\Shared\Components\IComponent;
...
class AutoloadingHandler extends IComponent {
	...
	protected function getAutoloader() {
		...
		if( ! $this->_psr4Autoloader ){
			...
			if ( ! class_exists( 'shellpress\v1_3_81\lib\Psr4Autoloader\Psr4AutoloaderClass' ) ) {
