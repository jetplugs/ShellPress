<?php
namespace shellpress\v1_3_1\src\Components\External;
...
use shellpress\v1_3_1\src\Shared\Components\IComponent;
...
class AutoloadingHandler extends IComponent {
	...
	protected function onSetUp() {
		...
		if ( ! class_exists( 'shellpress\v1_3_1\lib\Psr4Autoloader\Psr4AutoloaderClass' ) ) {
		...
		$this->psr4Autoloader->addNamespace( 'shellpress\v1_3_1', $this->s()->getShellPressDir() );
