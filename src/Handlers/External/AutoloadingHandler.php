...
class AutoloadingHandler extends IHandler {
	...
	protected function onSetUp() {
		...
		if ( ! class_exists( 'shellpress\v1_2_1\lib\Psr4Autoloader\Psr4AutoloaderClass' ) ) {
		...
		$this->psr4Autoloader->addNamespace( 'shellpress\v1_2_1', $this->shell()->getShellPressDir() );
