<?php
namespace shellpress\v1_1_6\src;
...
use shellpress\v1_1_6\lib\Psr4Autoloader\Psr4AutoloaderClass;
use shellpress\v1_1_6\src\Handlers\EventHandler;
use shellpress\v1_1_6\src\Handlers\LogHandler;
use shellpress\v1_1_6\src\Handlers\OptionsHandler;
use shellpress\v1_1_6\src\Handlers\UtilityHandler;

if( class_exists( 'shellpress\v1_1_6\src\Shell' ) ) return;
...
class Shell {
    ...
    private function initAutoloadingHandler() {
        ...
        if( ! class_exists( 'shellpress\v1_1_6\lib\Psr4Autoloader\Psr4AutoloaderClass' ) ){
        ...
        $this->autoloading->addNamespace( 'shellpress\v1_1_6', dirname( __DIR__ ) );
