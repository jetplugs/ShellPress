<?php
namespace shellpress\v1_2_6\src;
...
use shellpress\v1_2_6\lib\Psr4Autoloader\Psr4AutoloaderClass;
use shellpress\v1_2_6\ShellPress;
use shellpress\v1_2_6\src\Components\External\AutoloadingHandler;
use shellpress\v1_2_6\src\Components\External\EventHandler;
use shellpress\v1_2_6\src\Components\External\MustacheHandler;
use shellpress\v1_2_6\src\Components\External\UpdateHandler;
use shellpress\v1_2_6\src\Components\Internal\DebugHandler;
use shellpress\v1_2_6\src\Components\Internal\ExtractorHandler;
use shellpress\v1_2_6\src\Components\External\LogHandler;
use shellpress\v1_2_6\src\Components\External\MessagesHandler;
use shellpress\v1_2_6\src\Components\External\OptionsHandler;
use shellpress\v1_2_6\src\Components\External\UtilityHandler;

if( ! class_exists( 'shellpress\v1_2_6\src\Shell', false ) ) {
    ...
    class Shell {
        ...
        public function init( &$shellPress ) {
	        ...
	        if( ! class_exists( 'shellpress\v1_2_6\src\Shared\Components\IComponent', false ) )
		        require( __DIR__ . '/Shared/Components/IComponent.php' );
	        if( ! class_exists( 'shellpress\v1_2_6\src\Components\External\AutoloadingHandler', false ) )
