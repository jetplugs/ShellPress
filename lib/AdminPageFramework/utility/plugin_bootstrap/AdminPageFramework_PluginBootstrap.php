...
abstract class SP_v1_0_7_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('SP_v1_0_7_AdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new SP_v1_0_7_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
