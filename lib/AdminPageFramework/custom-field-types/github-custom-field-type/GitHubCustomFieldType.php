<?php
if ( ! class_exists( 'SP_v1_0_8_GitHubCustomFieldType' ) ) :
/**
 * @version     1.0.1
 */
class SP_v1_0_8_GitHubCustomFieldType extends SP_v1_0_8_AdminPageFramework_FieldType {
    ...
    protected function getField( $aField ) { 
        ...
        return 
            $aField['before_label']
            . "<div class='shellpress-input-label-container'>"        
                . $aField['before_input']
                . ( $aField['label'] && ! $aField['repeatable']
                    ? "<span class='shellpress-input-label-string' style='min-width:" . $this->getLengthSanitized( $aField['label_min_width'] ) . ";'>" . $aField['label'] . "</span>"
                    : "" 
                )
        ...
        private function _getButtonLabelByType( $sButtonType, $sUserName, $sValue ) {
            ...
            switch( $sButtonType ) {
                case 'follow': 
                    return sprintf( __( 'Follow @%1$s', 'shellpress' ), $sUserName );
                case 'watch':
                    return __( 'Watch', 'shellpress' );
                case 'star':
                    return __( 'Star', 'shellpress' );
                case 'fork':
                    return __( 'Fork', 'shellpress' );
                case 'issue':
                    return __( 'Issue', 'shellpress' );
                default:
                    return '';
            }                 
