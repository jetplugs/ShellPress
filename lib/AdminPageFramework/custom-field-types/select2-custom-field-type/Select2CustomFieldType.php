...
if ( ! class_exists( 'SP_v1_0_8_Select2CustomFieldType' ) ) :
/**
 ...
 */
class SP_v1_0_8_Select2CustomFieldType extends SP_v1_0_8_AdminPageFramework_FieldType_select {
...
"jQuery( document ).ready( function(){
    ...
    var _initializeSelect2 = function( oNode ) {
        ...
        if ( _aOptions[ 'width' ] && 'auto' !== _aOptions[ 'width' ] ) {
            var _oFieldContainer = _oSelect2Target.closest( '.shellpress-field-select2' );
            _oFieldContainer.css( 'width', _aOptions[ 'width' ] );
            _oFieldContainer.children( '.shellpress-select-label' )
                .css( 'width', '100%' );
            _oFieldContainer.children( '.shellpress-select-label' )
                .children( 'label' )
                .children( '.shellpress-input-container' )
                .css( 'width', '100%' );
            _aOptions[ 'width' ] = '100%';
        }
        ...
        if ( _aOptions[ 'search_callback' ] ) {
             ...
             * Set inital values.
             */
            var _oInputForEncoded = _oSelect2Target.closest( '.shellpress-field' )
            ...
            _oSelect2Target.on( 'change', function( event ){
                ...
                jQuery( this ).closest( '.shellpress-field' )
                    .children( 'input[data-encoded]' ).first()
    ...
    protected function getStyles() {
        return "
.shellpress-field-select2 .select2-container {     
    min-width: 200px;
    width: auto;
}

.shellpress-field-select2 {
    max-width: 96%;
}

/* Make a room for repeatable buttons */
.repeatable .shellpress-field-select2 > .shellpress-select-label > label > .shellpress-input-container {
    max-width: 84%;
}
