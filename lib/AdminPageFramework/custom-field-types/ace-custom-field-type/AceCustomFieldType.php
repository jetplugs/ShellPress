<?php
/**
 * SP_v1_0_8_AceCustomFieldType, for the  Admin Page Framework by Michael Uno, is written by Per Soderlind - http://soderlind.no
 */
if ( ! class_exists( 'SP_v1_0_8_AceCustomFieldType' ) ) :
class SP_v1_0_8_AceCustomFieldType extends SP_v1_0_8_AdminPageFramework_FieldType {
            ...
            jQuery().registerAPFCallback( {
                ...
                */
                added_repeatable_field: function( oCopied, sFieldType, sFieldTagID, iCallType ) {
                    ...
                    oCopied.closest( '.shellpress-field' ).nextAll().andSelf().each( function( iIndex ) {
