...
if ( ! class_exists( 'SP_v1_0_8_PostTypeTaxonomyCustomFieldType' ) ) :
/**
 ...
 */
class SP_v1_0_8_PostTypeTaxonomyCustomFieldType extends SP_v1_0_8_AdminPageFramework_FieldType_taxonomy {
...
jQuery( document ).ready( function(){
    ...
    jQuery( '.shellpress-checkbox-container-posttype[data-select_all_button]' ).each( function( iIndex ){
        jQuery( this ).before( '<div class=\"select_all_button_container\" onclick=\"jQuery( this ).selectAllSP_v1_0_8_AdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_all_button' ) + '</a></div>' );
    });            
    jQuery( '.shellpress-checkbox-container-posttype[data-select_none_button]' ).each( function( iIndex ){
        jQuery( this ).before( '<div class=\"select_none_button_container\" onclick=\"jQuery( this ).deselectAllSP_v1_0_8_AdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_none_button' ) + '</a></div>' );
    });
    
    // When the post type check-boxes are clicked, show/hide the corresponding taxonomy elements.
    jQuery( document ).on( 'change', '.shellpress-field-post_type_taxonomy .shellpress-field-posttype input[type="checkbox"]', function() {
        ...
        var _oField              = jQuery( this ).closest( '.shellpress-field-post_type_taxonomy' );
    ...
    jQuery( '.shellpress-field-post_type_taxonomy .shellpress-field-posttype input[type="checkbox"]:not(:checked)' ).each( function(){
    ...
    jQuery().registerSP_v1_0_8_AdminPageFrameworkCallbacks( {
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            oCloned.find( '.shellpress-field-posttype input[type="checkbox"]' )
                .prop( 'checked', false )
                .trigger( 'change' );         
...
.shellpress-field-post_type_taxonomy .select_all_button_container, 
.shellpress-field-post_type_taxonomy .select_none_button_container
{
...
.shellpress-field-post_type_taxonomy .select-taxonomy-terms-checkbox-container {
            ...
            return "<div class='select-taxonomy-terms-checkbox-container'>"
                    . "<label class='select-taxonomy-terms'>"
                        ...
                        . "<input " . $this->getAttributes( $_aCheckboxAttributes ) . " />"
                            . __( 'Select taxonomy terms.', 'shellpress-loader' )
                    . "</label>"
                . "</div>";
