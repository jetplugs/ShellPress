...
abstract class SP_v1_0_8_AdminPageFramework_Utility_Deprecated {
    static public function minifyCSS($sCSSRules) {
        SP_v1_0_8_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getCSSMinified()');
        return SP_v1_0_8_AdminPageFramework_Utility_String::getCSSMinified($sCSSRules);
    }
    static public function sanitizeLength($sLength, $sUnit = 'px') {
        SP_v1_0_8_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getLengthSanitized()');
        return SP_v1_0_8_AdminPageFramework_Utility_String::getLengthSanitized($sLength, $sUnit);
    }
    public static function getCorrespondingArrayValue($vSubject, $sKey, $sDefault = '', $bBlankToDefault = false) {
        SP_v1_0_8_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getElement()');
        if (!isset($vSubject)) {
            return $sDefault;
        }
    ...
    static public function isAssociativeArray(array $aArray) {
        SP_v1_0_8_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__);
    ...
    static public function getAttributes(array $aAttributes) {
        SP_v1_0_8_AdminPageFramework_Utility::showDeprecationNotice(__METHOD__, 'SP_v1_0_8_AdminPageFramework_WPUtility::getAttributes()');
        $_sQuoteCharactor = "'";
        $_aOutput = array();
...
abstract class SP_v1_0_8_AdminPageFramework_Utility_VariableType extends SP_v1_0_8_AdminPageFramework_Utility_Deprecated {
...
abstract class SP_v1_0_8_AdminPageFramework_Utility_String extends SP_v1_0_8_AdminPageFramework_Utility_VariableType {
...
abstract class SP_v1_0_8_AdminPageFramework_Utility_Array extends SP_v1_0_8_AdminPageFramework_Utility_String {
...
abstract class SP_v1_0_8_AdminPageFramework_Utility_ArrayGetter extends SP_v1_0_8_AdminPageFramework_Utility_Array {
...
abstract class SP_v1_0_8_AdminPageFramework_Utility_ArraySetter extends SP_v1_0_8_AdminPageFramework_Utility_ArrayGetter {
...
abstract class SP_v1_0_8_AdminPageFramework_Utility_Path extends SP_v1_0_8_AdminPageFramework_Utility_ArraySetter {
...
abstract class SP_v1_0_8_AdminPageFramework_Utility_URL extends SP_v1_0_8_AdminPageFramework_Utility_Path {
...
abstract class SP_v1_0_8_AdminPageFramework_Utility_File extends SP_v1_0_8_AdminPageFramework_Utility_URL {
...
abstract class SP_v1_0_8_AdminPageFramework_Utility_SystemInformation extends SP_v1_0_8_AdminPageFramework_Utility_File {
...
abstract class SP_v1_0_8_AdminPageFramework_Utility_HTMLAttribute extends SP_v1_0_8_AdminPageFramework_Utility_SystemInformation {
...
class SP_v1_0_8_AdminPageFramework_Utility extends SP_v1_0_8_AdminPageFramework_Utility_HTMLAttribute {
