...
class SP_v1_0_7_AdminPageFramework_AdminNotice extends SP_v1_0_7_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        new SP_v1_0_7_AdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }
