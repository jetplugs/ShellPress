...
class SP_v1_0_6_AdminPageFramework_AdminNotice extends SP_v1_0_6_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        $this->aAttributes['class'] = $this->getClassAttribute($this->aAttributes['class'], 'shellpress-settings-notice-message', 'shellpress-settings-notice-container', 'notice', 'is-dismissible');
        $this->aCallbacks = $aCallbacks + $this->aCallbacks;
        new SP_v1_0_6_AdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }
