...
class SP_v1_0_6_AdminPageFramework_AdminNotice___Script extends SP_v1_0_6_AdminPageFramework_Factory___Script_Base {
...
( function( $ ) {
    jQuery( document ).ready( function() {         
        ...
        var _oAdminNotices = jQuery( '.shellpress-settings-notice-message' );
        if ( _oAdminNotices.length ) {
            ...
            var _oContainer     = jQuery( _oAdminNotices )
                ...
                .wrap( "<div class='shellpress-admin-notice-animation-container'></div>" );
