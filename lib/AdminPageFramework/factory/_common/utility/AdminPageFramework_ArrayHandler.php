...
class SP_v1_0_7_AdminPageFramework_FrameworkUtility extends SP_v1_0_7_AdminPageFramework_WPUtility {
    ...
    static public function getFrameworkVersion($bTrimDevVer = false) {
        $_sVersion = SP_v1_0_7_AdminPageFramework_Registry::getVersion();
        return $bTrimDevVer ? self::getSuffixRemoved($_sVersion, '.dev') : $_sVersion;
    }
    static public function getFrameworkName() {
        return SP_v1_0_7_AdminPageFramework_Registry::NAME;
    }
    static public function getFrameworkNameVersion() {
        return self::getFrameworkName() . ' ' . self::getFrameworkVersion();
    }
}
class SP_v1_0_7_AdminPageFramework_ArrayHandler extends SP_v1_0_7_AdminPageFramework_FrameworkUtility {
    public $aData = array();
