...
class SP_v1_0_8_AdminPageFramework_Debug_Base extends SP_v1_0_8_AdminPageFramework_FrameworkUtility {
...
class SP_v1_0_8_AdminPageFramework_Debug_Log extends SP_v1_0_8_AdminPageFramework_Debug_Base {
...
class SP_v1_0_8_AdminPageFramework_Debug extends SP_v1_0_8_AdminPageFramework_Debug_Log {
    ...
    static public function dumpArray($asArray, $sFilePath = null) {
        self::showDeprecationNotice('SP_v1_0_8_AdminPageFramework_Debug::' . __FUNCTION__, 'SP_v1_0_8_AdminPageFramework_Debug::dump()');
        SP_v1_0_8_AdminPageFramework_Debug::dump($asArray, $sFilePath);
    }
    static public function getArray($asArray, $sFilePath = null, $bEscape = true) {
        self::showDeprecationNotice('SP_v1_0_8_AdminPageFramework_Debug::' . __FUNCTION__, 'SP_v1_0_8_AdminPageFramework_Debug::get()');
        return SP_v1_0_8_AdminPageFramework_Debug::get($asArray, $sFilePath, $bEscape);
    }
    static public function logArray($asArray, $sFilePath = null) {
        self::showDeprecationNotice('SP_v1_0_8_AdminPageFramework_Debug::' . __FUNCTION__, 'SP_v1_0_8_AdminPageFramework_Debug::log()');
        SP_v1_0_8_AdminPageFramework_Debug::log($asArray, $sFilePath);
    }
    static public function getAsString($mValue) {
        self::showDeprecationNotice('SP_v1_0_8_AdminPageFramework_Debug::' . __FUNCTION__);
