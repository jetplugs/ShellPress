...
abstract class SP_v1_0_8_AdminPageFramework_Form_Utility extends SP_v1_0_8_AdminPageFramework_FrameworkUtility {
    ...
    static public function getFieldsetReformattedBySubFieldIndex($aFieldset, $iSubFieldIndex, $bHasSubFields, $aParentFieldset) {
        ...
        $_oFieldsetFormatter = new SP_v1_0_8_AdminPageFramework_Form_Model___Format_Fieldset($aFieldset, $aFieldset['_structure_type'], $aFieldset['capability'], ( integer )$iSubFieldIndex + 1, $aFieldset['_subsection_index'], $aFieldset['_is_section_repeatable'], $aFieldset['_caller_object']);
        $aFieldset = $_oFieldsetFormatter->get();
        $_oFieldsetOutputFormatter = new SP_v1_0_8_AdminPageFramework_Form_Model___Format_FieldsetOutput($aFieldset, $aFieldset['_section_index'], $_oCallerForm->aFieldTypeDefinitions);
...
abstract class SP_v1_0_8_AdminPageFramework_Form_Base extends SP_v1_0_8_AdminPageFramework_Form_Utility {
...
class SP_v1_0_8_AdminPageFramework_Form_Model extends SP_v1_0_8_AdminPageFramework_Form_Base {
    ...
    public function getSortedInputs(array $aFormInputs) {
        ...
        $_oInputSorter = new SP_v1_0_8_AdminPageFramework_Form_Model___Modifier_SortInput($aFormInputs, $_aDynamicFieldAddressKeys);
    ...
    public function dropRepeatableElements(array $aSubject) {
        $_oFilterRepeatableElements = new SP_v1_0_8_AdminPageFramework_Form_Model___Modifier_FilterRepeatableElements($aSubject, $this->getElementAsArray($_POST, '__repeatable_elements_' . $this->aArguments['structure_type']));
    ...
    public function _replyToRegisterFormItems() {
        ...
        $_oFieldResources = new SP_v1_0_8_AdminPageFramework_Form_Model___SetFieldResources($this->aArguments, $this->aFieldsets, self::$_aResources, $this->aFieldTypeDefinitions, $this->aCallbacks);
    ...
    private function _setSiteWideFieldTypeDefinitions() {
        ...
        $_oBuiltInFieldTypeDefinitions = new SP_v1_0_8_AdminPageFramework_Form_Model___BuiltInFieldTypeDefinitions('admin_page_framework', $this->oMsg);
    ...
    public function getDefaultFormValues() {
        $_oDefaultValues = new SP_v1_0_8_AdminPageFramework_Form_Model___DefaultValues($this->aFieldsets);
        return $_oDefaultValues->get();
    }
    protected function _formatElementDefinitions(array $aSavedData) {
        $_oSectionsetsFormatter = new SP_v1_0_8_AdminPageFramework_Form_Model___FormatSectionsets($this->aSectionsets, $this->aArguments['structure_type'], $this->sCapability, $this->aCallbacks, $this);
        $this->aSectionsets = $_oSectionsetsFormatter->get();
        $_oFieldsetsFormatter = new SP_v1_0_8_AdminPageFramework_Form_Model___FormatFieldsets($this->aFieldsets, $this->aSectionsets, $this->aArguments['structure_type'], $this->aSavedData, $this->sCapability, $this->aCallbacks, $this);
...
class SP_v1_0_8_AdminPageFramework_Form_View extends SP_v1_0_8_AdminPageFramework_Form_Model {
    public function __construct() {
        parent::__construct();
        new SP_v1_0_8_AdminPageFramework_Form_View__Resource($this);
    }
    public function get() {
...
class SP_v1_0_8_AdminPageFramework_Form_Controller extends SP_v1_0_8_AdminPageFramework_Form_View {
...
class SP_v1_0_8_AdminPageFramework_Form extends SP_v1_0_8_AdminPageFramework_Form_Controller {
    ...
    public $oFieldError;
    public $oLastInputs;
    public $aSubClasses = array('submit_notice' => 'SP_v1_0_8_AdminPageFramework_Form___SubmitNotice', 'field_error' => 'SP_v1_0_8_AdminPageFramework_Form___FieldError', 'last_input' => 'SP_v1_0_8_AdminPageFramework_Form_Model___LastInput', 'message' => 'SP_v1_0_8_AdminPageFramework_Message',);
    public function __construct() {
