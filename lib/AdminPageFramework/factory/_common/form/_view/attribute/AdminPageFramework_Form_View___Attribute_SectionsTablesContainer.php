...
class SP_v1_0_6_AdminPageFramework_Form_View___Attribute_SectionsTablesContainer extends SP_v1_0_6_AdminPageFramework_Form_View___Attribute_Base {
    ...
    private function _getDynamicElementArguments($aSectionset) {
        ...
        $_oSectionNameGenerator = new SP_v1_0_6_AdminPageFramework_Form_View___Generate_SectionName($aSectionset, $aSectionset['_caller_object']->aCallbacks['hfSectionName']);
