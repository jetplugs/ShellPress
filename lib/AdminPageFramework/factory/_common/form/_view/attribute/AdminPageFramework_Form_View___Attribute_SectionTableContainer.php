...
class SP_v1_0_6_AdminPageFramework_Form_View___Attribute_SectionTableContainer extends SP_v1_0_6_AdminPageFramework_Form_View___Attribute_Base {
    protected function _getAttributes() {
        $_aSectionAttributes = $this->uniteArrays($this->dropElementsByType($this->aArguments['attributes']), array('id' => $this->aArguments['_tag_id'], 'class' => $this->getClassAttribute('shellpress-section', $this->getAOrB($this->aArguments['section_tab_slug'], 'shellpress-tab-content', null), $this->getAOrB($this->aArguments['_is_collapsible'], 'is_subsection_collapsible', null)),));
