...
class SP_v1_0_8_AdminPageFramework_Form_View___DebugInfo extends SP_v1_0_8_AdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        return "<div class='shellpress-info'>" . $this->oMsg->get('debug_info') . ': ' . $this->getFrameworkNameVersion() . "</div>";
    }
