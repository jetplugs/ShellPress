...
class SP_v1_0_6_AdminPageFramework_Form_View___Script_CollapsibleSection extends SP_v1_0_6_AdminPageFramework_Form_View___Script_Base {
...
( function( $ ) {
    ...
    jQuery( document ).ready( function() {
        jQuery( this ).initializeSP_v1_0_6_AdminPageFrameworkCollapsibleSections();
    });              
    ...
    jQuery( document ).bind( 'shellpress_saved_widget', function( event, oWidget ){
        jQuery( oWidget ).initializeSP_v1_0_6_AdminPageFrameworkCollapsibleSections();
    });    
    
    $.fn.initializeSP_v1_0_6_AdminPageFrameworkCollapsibleSections = function() {
        ...
        jQuery( this ).find( '.shellpress-collapsible-sections-title, .shellpress-collapsible-section-title' )
            .enableSP_v1_0_6_AdminPageFrameworkCollapsibleButton();
     ...
     */
    $.fn.enableSP_v1_0_6_AdminPageFrameworkCollapsibleButton = function() {
