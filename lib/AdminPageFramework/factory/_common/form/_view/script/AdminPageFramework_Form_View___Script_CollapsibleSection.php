...
class SP_v1_0_7_AdminPageFramework_Form_View___Script_CollapsibleSection extends SP_v1_0_7_AdminPageFramework_Form_View___Script_Base {
...
( function( $ ) {
    ...
    jQuery( document ).ready( function() {
        jQuery( this ).initializeSP_v1_0_7_AdminPageFrameworkCollapsibleSections();
    });              
    ...
    jQuery( document ).bind( 'shellpress_saved_widget', function( event, oWidget ){
        jQuery( oWidget ).initializeSP_v1_0_7_AdminPageFrameworkCollapsibleSections();
    });    
    
    $.fn.initializeSP_v1_0_7_AdminPageFrameworkCollapsibleSections = function() {
        ...
        jQuery( this ).find( '.shellpress-collapsible-sections-title, .shellpress-collapsible-section-title' )
            .enableSP_v1_0_7_AdminPageFrameworkCollapsibleButton();
     ...
     */
    $.fn.enableSP_v1_0_7_AdminPageFrameworkCollapsibleButton = function() {
