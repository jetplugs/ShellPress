...
class SP_v1_0_6_AdminPageFramework_Form_View___Script_SectionTab extends SP_v1_0_6_AdminPageFramework_Form_View___Script_Base {
...
jQuery( '.shellpress-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='shellpress-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}
