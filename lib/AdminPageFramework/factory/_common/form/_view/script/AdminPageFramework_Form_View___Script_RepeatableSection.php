...
class SP_v1_0_6_AdminPageFramework_Form_View___Script_RepeatableSection extends SP_v1_0_6_AdminPageFramework_Form_View___Script_Base {
...
( function( $ ) {
     ...
     */
    $.fn.updateSP_v1_0_6_AdminPageFrameworkRepeatableSections = function( aSettings ) {
        ...
        if ( ! $.fn.aSP_v1_0_6_AdminPageFrameworkRepeatableSectionsOptions ) {
            $.fn.aSP_v1_0_6_AdminPageFrameworkRepeatableSectionsOptions = [];
        }
        if ( ! $.fn.aSP_v1_0_6_AdminPageFrameworkRepeatableSectionsOptions.hasOwnProperty( _sSectionsContainerID ) ) {
            $.fn.aSP_v1_0_6_AdminPageFrameworkRepeatableSectionsOptions[ _sSectionsContainerID ] = $.extend(
                {    
        ...
        var _aOptions = $.fn.aSP_v1_0_6_AdminPageFrameworkRepeatableSectionsOptions[ _sSectionsContainerID ];
        ...
        $( _oThis ).find( '.repeatable-section-add-button' ).click( function() {
            ...
            $( this ).addSP_v1_0_6_AdminPageFrameworkRepeatableSection();
        ...
        $( _oThis ).find( '.repeatable-section-remove-button' ).click( function() {
            $( this ).removeSP_v1_0_6_AdminPageFrameworkRepeatableSection();
            return false; // will not click after that
        });     
        ...
        if ( _aOptions[ 'min' ] > 0 && _nCurrentSectionCount > 0 ) {
            if ( ( _aOptions[ 'min' ] - _nCurrentSectionCount ) > 0 ) {     
                $( '#' + _sSectionID ).addSP_v1_0_6_AdminPageFrameworkRepeatableSection( _sSectionID );  
            }
        }
     ...
     */    
    $.fn.addSP_v1_0_6_AdminPageFrameworkRepeatableSection = function( sSectionContainerID ) {
        ...
        var _iFadein                = $.fn.aSP_v1_0_6_AdminPageFrameworkRepeatableSectionsOptions[ sSectionsContainerID ][ 'fadein' ];
        var _iFadeout               = $.fn.aSP_v1_0_6_AdminPageFrameworkRepeatableSectionsOptions[ sSectionsContainerID ][ 'fadeout' ];
        
        // If the set maximum number of sections already exists, do not add.
        var _sMaxNumberOfSections   = $.fn.aSP_v1_0_6_AdminPageFrameworkRepeatableSectionsOptions[ sSectionsContainerID ][ 'max' ];
        ...
        if( 'function' === typeof nodeNewSection.enableSP_v1_0_6_AdminPageFrameworkCollapsibleButton ){ 
            nodeNewSection.find( '.shellpress-collapsible-sections-title, .shellpress-collapsible-section-title' ).enableSP_v1_0_6_AdminPageFrameworkCollapsibleButton();
        }
        ...
        $( nodeNewSection ).find( '.shellpress-field' ).each( function( iFieldIndex ) {
            ...
            $( this ).updateSP_v1_0_6_AdminPageFrameworkRepeatableFields();
        ...
        nodeNewSection.updateSP_v1_0_6_AdminPageFrameworkRepeatableSections();    
        
        // Rebind sortable fields - iterate sortable fields containers.
        nodeNewSection.find( '.shellpress-fields.sortable' ).each( function() {
            $( this ).enableSP_v1_0_6_AdminPageFrameworkSortableFields();
        });
     ...
     */
    $.fn.removeSP_v1_0_6_AdminPageFrameworkRepeatableSection = function() {
        ...
        var _sMinNumberOfSections = $.fn.aSP_v1_0_6_AdminPageFrameworkRepeatableSectionsOptions[ sSectionsContainerID ][ 'min' ];
...
jQuery( document ).ready( function() {
    ...
    // Update the fields     
    jQuery( '#{$sContainerTagID}' ).updateSP_v1_0_6_AdminPageFrameworkRepeatableSections( $_aJSArray ); 
});            
JAVASCRIPTS;
