...
class SP_v1_0_6_AdminPageFramework_Form_View___Script_Widget extends SP_v1_0_6_AdminPageFramework_Form_View___Script_Base {
    ...
    $( document ).ready( function() {
        ...
        $( document ).ajaxComplete( function( event, XMLHttpRequest, ajaxOptions ) {
            ...
            if( _aRequest.action && ( 'save-widget' === _aRequest.action ) ) {
                ...
                if ( $( _oWidget ).find( '.shellpress-sectionset' ).length <= 0 ) { 
                    return; 
                }   
