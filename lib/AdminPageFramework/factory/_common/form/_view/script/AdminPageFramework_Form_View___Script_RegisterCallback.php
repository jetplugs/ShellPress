...
class SP_v1_0_6_AdminPageFramework_Form_View___Script_RegisterCallback extends SP_v1_0_6_AdminPageFramework_Form_View___Script_Base {
    static public function getScript() {
        return <<<JAVASCRIPTS
(function ( $ ) {
            
    // Callback containers.
    $.fn.aSP_v1_0_6_AdminPageFrameworkAddRepeatableFieldCallbacks        = [];            
    $.fn.aSP_v1_0_6_AdminPageFrameworkRepeatFieldCallbacks               = [];    // 3.8.8+
    $.fn.aSP_v1_0_6_AdminPageFrameworkRemoveRepeatableFieldCallbacks     = [];
    $.fn.aSP_v1_0_6_AdminPageFrameworkSortedFieldsCallbacks              = [];            
    $.fn.aSP_v1_0_6_AdminPageFrameworkStoppedSortingFieldsCallbacks      = [];
    $.fn.aSP_v1_0_6_AdminPageFrameworkAddedWidgetCallbacks               = [];
    $.fn.aSP_v1_0_6_AdminPageFrameworkStoppedSortingSectionsCallbacks    = [];    // 3.8.0+
    ...
    $( document ).bind( 'shellpress_added_repeatable_field', function( oEvent, sFieldType, sID, iCallType, iSectionIndex, iFieldIndex ){          
        ...
        $.each( $.fn.aSP_v1_0_6_AdminPageFrameworkAddRepeatableFieldCallbacks, function( iIndex, aCallback ) {
            ...
            if ( -1 === $.inArray( sFieldType, [ '_nested', 'inline_mixed' ] ) ) {                
                console.warn( 'Admin Page Framework (' + sFieldType + ' field type): The `added_repeatable_field` callback argument for the `registerSP_v1_0_6_AdminPageFrameworkCallbacks` method is deprecated. Use `repeated_field` instead.' );
            }
    ...
    $( document ).bind( 'shellpress_repeated_field', function( oEvent, iCallType, oModelContainer ){
        ...
        $.each( $.fn.aSP_v1_0_6_AdminPageFrameworkRepeatFieldCallbacks, function( iIndex, aCallback ) {
            var _hfCallback  = aCallback[ 0 ];
            var _aFieldTypes = aCallback[ 1 ]; // '_nested', 'inline_mixed' are built-in
            if ( -1 !== $.inArray( sFieldType, [ '_nested', 'inline_mixed' ] ) ) {
                return true;    // continue
    ...
    $( document ).bind( 'shellpress_stopped_sorting_sections', function( oEvent ){  
        ...
        var _oThisNode = jQuery( oEvent.target );
        $.each( $.fn.aSP_v1_0_6_AdminPageFrameworkStoppedSortingSectionsCallbacks, function( iIndex, aCallback ) {
            var _hfCallback  = aCallback[ 0 ];
    ...
    /* $( document ).bind( 'shellpress_removed_field', function( oEvent, sFieldType, sID, iCallType, iSectionIndex, iFieldIndex ){
        var _oThisNode = jQuery( oEvent.target );
        $.each( $.fn.aSP_v1_0_6_AdminPageFrameworkRemoveRepeatableFieldCallbacks, function( iIndex, aCallback ) {
            var _hfCallback  = aCallback[ 0 ];
            var _aFieldTypes = aCallback[ 1 ];       
            if ( 2 < _aFieldTypes.length && -1 === $.inArray( sFieldType, _aFieldTypes ) ) {
                return true; // continue
    ...
    $.fn.callBackSortedFields = function( sFieldType, sID, iCallType ) {
        var oThisNode = this;
        $.fn.aSP_v1_0_6_AdminPageFrameworkSortedFieldsCallbacks.forEach( function( aCallback ) {
            var _hfCallback  = aCallback[ 0 ];
    ...
    $.fn.callBackStoppedSortingFields = function( sFieldType, sID, iCallType ) {
        var oThisNode = this;
        $.fn.aSP_v1_0_6_AdminPageFrameworkStoppedSortingFieldsCallbacks.forEach( function( aCallback ) {
            var _hfCallback  = aCallback[ 0 ];
            var _aFieldTypes = aCallback[ 1 ]; // '_nested', 'inline_mixed' are built-in
            if ( 2 < _aFieldTypes.length && -1 === $.inArray( sFieldType, _aFieldTypes ) ) {
                return true; // continue
    ...
    $( document ).bind( 'shellpress_saved_widget', function( event, oWidget ){
        $.each( $.fn.aSP_v1_0_6_AdminPageFrameworkAddedWidgetCallbacks, function( iIndex, aCallback ) {
            var _hfCallback  = aCallback[ 0 ];
            var _aFieldTypes = aCallback[ 1 ];
            if ( ! $.isFunction( _hfCallback ) ) { 
                return true;    // continue
     ...
     */
    $.fn.registerSP_v1_0_6_AdminPageFrameworkCallbacks = function( oCallbacks, aFieldTypeSlugs ) {
        ...
        $.fn.aSP_v1_0_6_AdminPageFrameworkAddRepeatableFieldCallbacks.push( 
            [ oCallbacks.added_repeatable_field, aFieldTypeSlugs ]
        );

        $.fn.aSP_v1_0_6_AdminPageFrameworkRepeatFieldCallbacks.push(  // 3.8.8+
            [ oCallbacks.repeated_field, aFieldTypeSlugs ]
        );        
        $.fn.aSP_v1_0_6_AdminPageFrameworkRemoveRepeatableFieldCallbacks.push( 
            [ oCallbacks.removed_repeatable_field, aFieldTypeSlugs ]
        );
        $.fn.aSP_v1_0_6_AdminPageFrameworkSortedFieldsCallbacks.push( 
            [ oCallbacks.sorted_fields, aFieldTypeSlugs ]
        );
        $.fn.aSP_v1_0_6_AdminPageFrameworkStoppedSortingFieldsCallbacks.push( 
            [ oCallbacks.stopped_sorting_fields, aFieldTypeSlugs ]
        );
        $.fn.aSP_v1_0_6_AdminPageFrameworkAddedWidgetCallbacks.push( 
            [ oCallbacks.saved_widget, aFieldTypeSlugs ]
        );

        // 3.8.0
        $.fn.aSP_v1_0_6_AdminPageFrameworkStoppedSortingSectionsCallbacks.push( 
            [ oCallbacks.stopped_sorting_sections, aFieldTypeSlugs ]
        );        

    };
    /**
     * An alias of the `registerSP_v1_0_6_AdminPageFrameworkCalbacks()` method.
    ...
    $.fn.registerAPFCallback = function( oCallbacks, aFieldTypeSlugs ) {
        $.fn.registerSP_v1_0_6_AdminPageFrameworkCallbacks( oCallbacks, aFieldTypeSlugs );
    }
