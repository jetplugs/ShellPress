...
class SP_v1_0_7_AdminPageFramework_Form_View___Script_RepeatableField extends SP_v1_0_7_AdminPageFramework_Form_View___Script_Base {
...
(function ( $ ) {
     ...
     */
    $.fn.updateSP_v1_0_7_AdminPageFrameworkRepeatableFields = function( aSettings ) {
        ...
        if ( ! $.fn.aSP_v1_0_7_AdminPageFrameworkRepeatableFieldsOptions ) {
            $.fn.aSP_v1_0_7_AdminPageFrameworkRepeatableFieldsOptions = [];
        }
        if ( ! $.fn.aSP_v1_0_7_AdminPageFrameworkRepeatableFieldsOptions.hasOwnProperty( _sFieldsContainerID ) ) {     
            $.fn.aSP_v1_0_7_AdminPageFrameworkRepeatableFieldsOptions[ _sFieldsContainerID ] = $.extend({    
        ...
        var _aOptions = $.fn.aSP_v1_0_7_AdminPageFrameworkRepeatableFieldsOptions[ _sFieldsContainerID ];
...
// @todo For nested fields, the `find()` method should be avoided.         
        ...
        $( nodeThis ).find( '.repeatable-field-add-button' ).click( function() {
            ...
            $( this ).addSP_v1_0_7_AdminPageFrameworkRepeatableField();
...
// @todo For nested fields, the `find()` method should be avoided.        
        ...
        $( nodeThis ).find( '.repeatable-field-remove-button' ).click( function() {
            $( this ).removeSP_v1_0_7_AdminPageFrameworkRepeatableField();
            return false; // will not click after that
        });
        ...
        if ( _aOptions[ 'min' ] > 0 && _nCurrentFieldCount > 0 ) {
            if ( ( _aOptions[ 'min' ] - _nCurrentFieldCount ) > 0 ) {     
                $( '#' + _sFieldID ).addSP_v1_0_7_AdminPageFrameworkRepeatableField( _sFieldID );  
            }
        }
     ...
     */
    $.fn.addSP_v1_0_7_AdminPageFrameworkRepeatableField = function( sFieldContainerID ) {
        ...
        if ( ! $.fn.aSP_v1_0_7_AdminPageFrameworkRepeatableFieldsOptions.hasOwnProperty( _sFieldsContainerID ) ) {     
            ...
            $.fn.aSP_v1_0_7_AdminPageFrameworkRepeatableFieldsOptions[ _sFieldsContainerID ] = {    
        ...
        var _iFadein  = $.fn.aSP_v1_0_7_AdminPageFrameworkRepeatableFieldsOptions[ _sFieldsContainerID ][ 'fadein' ];
        var _iFadeout = $.fn.aSP_v1_0_7_AdminPageFrameworkRepeatableFieldsOptions[ _sFieldsContainerID ][ 'fadeout' ];

        // Show a warning message if the user tries to add more fields than the number of allowed fields.
        var sMaxNumberOfFields = $.fn.aSP_v1_0_7_AdminPageFrameworkRepeatableFieldsOptions[ _sFieldsContainerID ]['max'];
         ...
         */
        nodeNewField.updateSP_v1_0_7_AdminPageFrameworkRepeatableFields();
...
// @todo find() may not be appropriate for nested fields.
     ...
     * Removes a repeatable field.
      This method is called when the user presses the - repeatable button.
     */
    $.fn.removeSP_v1_0_7_AdminPageFrameworkRepeatableField = function() {
        ...
        var sMinNumberOfFields  = $.fn.aSP_v1_0_7_AdminPageFrameworkRepeatableFieldsOptions[ _sFieldsContainerID ][ 'min' ];
        if ( sMinNumberOfFields != 0 && nodeFieldsContainer.find( '.shellpress-field' ).length <= sMinNumberOfFields ) {
            ...
            var _iFadeout = $.fn.aSP_v1_0_7_AdminPageFrameworkRepeatableFieldsOptions[ _sFieldsContainerID ][ 'fadeout' ]
                ? $.fn.aSP_v1_0_7_AdminPageFrameworkRepeatableFieldsOptions[ _sFieldsContainerID ][ 'fadeout' ]
                : 500;
            nodeMessage.delay( 2000 ).fadeOut( _iFadeout );
            return;     
        }     
