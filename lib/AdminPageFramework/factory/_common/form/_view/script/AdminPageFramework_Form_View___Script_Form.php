...
class SP_v1_0_8_AdminPageFramework_Form_View___Script_Form extends SP_v1_0_8_AdminPageFramework_Form_View___Script_Base {
    static public function getScript() {
        return <<<JAVASCRIPTS
( function( $ ) {

    var _removeSP_v1_0_8_AdminPageFrameworkLoadingOutputs = function() {
    ...
    window.onerror = function(){
        ...
        _removeSP_v1_0_8_AdminPageFrameworkLoadingOutputs();
