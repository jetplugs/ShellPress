...
class SP_v1_0_8_AdminPageFramework_Form_View___Script_CheckboxSelector extends SP_v1_0_8_AdminPageFramework_Form_View___Script_Base {
...
(function ( $ ) {
     ...
     */        
    $.fn.selectAllSP_v1_0_8_AdminPageFrameworkCheckboxes = function() {
        jQuery( this ).parent()
     ...
     */
    $.fn.deselectAllSP_v1_0_8_AdminPageFrameworkCheckboxes = function() {
        jQuery( this ).parent()
            .find( 'input[type=checkbox]' )
            .attr( 'checked', false )
            .trigger( 'change' );   // 3.8.8+
