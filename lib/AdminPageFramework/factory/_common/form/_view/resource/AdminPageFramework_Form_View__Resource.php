...
class SP_v1_0_7_AdminPageFramework_Form_View__Resource extends SP_v1_0_7_AdminPageFramework_FrameworkUtility {
    public $oForm;
    ...
    private function _setHooks() {
        ...
        new SP_v1_0_7_AdminPageFramework_Form_View__Resource__Head($this->oForm, 'wp_head');
    }
    private function _setAdminHooks() {
        ...
        new SP_v1_0_7_AdminPageFramework_Form_View__Resource__Head($this->oForm, 'admin_head');
    }
