...
class SP_v1_0_8_AdminPageFramework_Form_View__Resource__Head extends SP_v1_0_8_AdminPageFramework_FrameworkUtility {
    public $oForm;
    ...
    private function _getInternalCSS() {
        $_oLoadingCSS = new SP_v1_0_8_AdminPageFramework_Form_View___CSS_Loading;
