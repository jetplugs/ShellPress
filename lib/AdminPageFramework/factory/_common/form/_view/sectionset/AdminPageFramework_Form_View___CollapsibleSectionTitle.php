...
class SP_v1_0_6_AdminPageFramework_Form_View___Section_Base extends SP_v1_0_6_AdminPageFramework_Form_Base {
    ...
    public function getFieldsetOutput($aFieldset) {
        ...
        $_oFieldset = new SP_v1_0_6_AdminPageFramework_Form_View___Fieldset($aFieldset, $this->aSavedData, $this->aFieldErrors, $this->aFieldTypeDefinitions, $this->oMsg, $this->aCallbacks);
        $_sFieldOutput = $_oFieldset->get();
        return $_sFieldOutput;
    }
}
class SP_v1_0_6_AdminPageFramework_Form_View___SectionTitle extends SP_v1_0_6_AdminPageFramework_Form_View___Section_Base {
    ...
    private function _getToolTip($_aSectionset) {
        ...
        $_oToolTip = new SP_v1_0_6_AdminPageFramework_Form_View___ToolTip($_aSectionset['tip'], $_sSectionTitleTagID);
    ...
    private function _getFieldsetsInSectionTitleArea(array $aFieldsets, $iSectionIndex, $aFieldTypeDefinitions) {
        ...
        foreach ($aFieldsets as $_aFieldset) {
            ...
            $_oFieldsetOutputFormatter = new SP_v1_0_6_AdminPageFramework_Form_Model___Format_FieldsetOutput($_aFieldset, $iSectionIndex, $aFieldTypeDefinitions);
...
class SP_v1_0_6_AdminPageFramework_Form_View___CollapsibleSectionTitle extends SP_v1_0_6_AdminPageFramework_Form_View___SectionTitle {
    ...
    protected function _getCollapsibleSectionsEnablerScript() {
        ...
        self::$_bLoaded = true;
        new SP_v1_0_6_AdminPageFramework_Form_View___Script_CollapsibleSection($this->oMsg);
    }
}
