...
class SP_v1_0_6_AdminPageFramework_Form_View___FieldTitle extends SP_v1_0_6_AdminPageFramework_Form_Utility {
    ...
    public function get() {
        ...
        $_oInputTagIDGenerator = new SP_v1_0_6_AdminPageFramework_Form_View___Generate_FieldInputID($aField, 0);
    ...
    private function _getFieldOutputsInFieldTitleAreaFromNestedFields($aField) {
        ...
        foreach ($aField['content'] as $_aNestedField) {
            ...
            $_oFieldset = new SP_v1_0_6_AdminPageFramework_Form_View___Fieldset($_aNestedField, $this->aSavedData, $this->aFieldErrors, $this->aFieldTypeDefinitions, $this->oMsg, $this->aCallbacks);
            $_sOutput.= $_oFieldset->get();
        }
        return $_sOutput;
    }
    private function _getToolTip($asTip, $sElementID) {
        $_oToolTip = new SP_v1_0_6_AdminPageFramework_Form_View___ToolTip($asTip, $sElementID);
