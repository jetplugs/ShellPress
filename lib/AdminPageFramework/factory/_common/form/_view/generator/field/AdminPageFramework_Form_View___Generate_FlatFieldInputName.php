...
class SP_v1_0_8_AdminPageFramework_Form_View___Generate_FieldInputName extends SP_v1_0_8_AdminPageFramework_Form_View___Generate_FlatFieldName {
    public $sIndex = '';
...
class SP_v1_0_8_AdminPageFramework_Form_View___Generate_FlatFieldInputName extends SP_v1_0_8_AdminPageFramework_Form_View___Generate_FieldInputName {
    public function get() {
        $_sIndex = $this->getAOrB('0' !== $this->sIndex && empty($this->sIndex), '', "|{$this->sIndex}");
