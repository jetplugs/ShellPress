...
class SP_v1_0_8_AdminPageFramework_Form_Model___SetFieldResources extends SP_v1_0_8_AdminPageFramework_Form_Base {
    ...
    private function ___setCommon() {
        ...
        new SP_v1_0_8_AdminPageFramework_Form_View___Script_RegisterCallback;
        $this->___setCommonFormInternalCSSRules();
    }
    private function ___setCommonFormInternalCSSRules() {
        $_aClassNames = array('SP_v1_0_8_AdminPageFramework_Form_View___CSS_Form', 'SP_v1_0_8_AdminPageFramework_Form_View___CSS_Field', 'SP_v1_0_8_AdminPageFramework_Form_View___CSS_Section', 'SP_v1_0_8_AdminPageFramework_Form_View___CSS_CollapsibleSection', 'SP_v1_0_8_AdminPageFramework_Form_View___CSS_FieldError', 'SP_v1_0_8_AdminPageFramework_Form_View___CSS_ToolTip',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
            $this->aResources['internal_styles'][] = $_oCSS->get();
        }
        $_aClassNamesForIE = array('SP_v1_0_8_AdminPageFramework_Form_View___CSS_CollapsibleSectionIE',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
    ...
    private function ___setFieldResourcesByFieldTypeDefinition($aFieldset, $_sFieldtype, $_aFieldTypeDefinition) {
        ...
        new SP_v1_0_8_AdminPageFramework_Form_Model___FieldTypeRegistration($_aFieldTypeDefinition, $this->aArguments['structure_type']);
        $_oFieldTypeResources = new SP_v1_0_8_AdminPageFramework_Form_Model___FieldTypeResource($_aFieldTypeDefinition, $this->aResources);
