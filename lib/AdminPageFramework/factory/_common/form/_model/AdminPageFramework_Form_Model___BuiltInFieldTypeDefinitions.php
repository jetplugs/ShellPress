...
class SP_v1_0_8_AdminPageFramework_Form_Model___BuiltInFieldTypeDefinitions {
    ...
    public function get() {
        ...
        foreach (self::$_aDefaultFieldTypeSlugs as $_sFieldTypeSlug) {
            $_sFieldTypeClassName = "SP_v1_0_8_AdminPageFramework_FieldType_{$_sFieldTypeSlug}";
