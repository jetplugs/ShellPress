...
class SP_v1_0_8_AdminPageFramework_Form___SubmitNotice extends SP_v1_0_8_AdminPageFramework_FrameworkUtility {
    ...
    public function render() {
        new SP_v1_0_8_AdminPageFramework_AdminNotice('');
    ...
    private function _printNotices($aNotices) {
        ...
        foreach (array_filter(( array )$aNotices, 'is_array') as $_aNotice) {
            ...
            new SP_v1_0_8_AdminPageFramework_AdminNotice($this->getElement($_aNotice, 'sMessage'), $this->getElement($_aNotice, 'aAttributes'));
        }
    }
}
