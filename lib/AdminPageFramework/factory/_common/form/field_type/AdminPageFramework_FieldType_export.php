...
class SP_v1_0_7_AdminPageFramework_FieldType_submit extends SP_v1_0_7_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".shellpress-field input[type='submit'] {margin-bottom: 0.5em;}";
    }
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'shellpress-input-label-container' . ' shellpress-input-button-container' . ' shellpress-input-container',);
    }
...
class SP_v1_0_7_AdminPageFramework_FieldType_export extends SP_v1_0_7_AdminPageFramework_FieldType_submit {
