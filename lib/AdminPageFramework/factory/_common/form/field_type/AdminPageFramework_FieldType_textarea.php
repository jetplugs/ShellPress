...
class SP_v1_0_7_AdminPageFramework_FieldType_textarea extends SP_v1_0_7_AdminPageFramework_FieldType {
...
jQuery( document ).ready( function(){
    ...
    var updateFoundEditors = function( oElements ) {
        ...
        oElements.each( function( iIndex ) {
            ...
            var oSettings = jQuery().getSP_v1_0_7_AdminPageFrameworkInputOptions( oWrap.attr( 'data-id' ) );   
    ...
    jQuery().registerSP_v1_0_7_AdminPageFrameworkCallbacks( {	
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            var _oSettings = jQuery().getSP_v1_0_7_AdminPageFrameworkInputOptions( _oWrap.attr( 'data-id' ) );  
        ...
        saved_widget : function( oWidget ) { 
            ...
            jQuery( oWidget ).find( '.shellpress-field' ).each( function( iIndex ) {
                ...
                // Store the settings.
                jQuery().storeSP_v1_0_7_AdminPageFrameworkInputOptions( 
                    oWrap.attr( 'data-id' ), 
                    { 
