...
abstract class SP_v1_0_6_AdminPageFramework_FieldType_Base extends SP_v1_0_6_AdminPageFramework_Form_Utility {
    ...
    public function __construct($asClassName = 'admin_page_framework', $asFieldTypeSlug = null, $oMsg = null, $bAutoRegister = true) {
        ...
        $this->oMsg = $oMsg ? $oMsg : SP_v1_0_6_AdminPageFramework_Message::getInstance();
        if ($bAutoRegister) {
    ...
    protected function getFieldOutput(array $aFieldset) {
        ...
        $_oFieldset = new SP_v1_0_6_AdminPageFramework_Form_View___Fieldset($aFieldset, $_oCallerForm->aSavedData, $_oCallerForm->getFieldErrors(), $_oCallerForm->aFieldTypeDefinitions, $_oCallerForm->oMsg, $_oCallerForm->aCallbacks);
    ...
    protected function enqueueMediaUploader() {
        ...
        if (function_exists('wp_enqueue_media')) {
            new SP_v1_0_6_AdminPageFramework_Form_View___Script_MediaUploader($this->oMsg);
        } else {
...
abstract class SP_v1_0_6_AdminPageFramework_FieldType extends SP_v1_0_6_AdminPageFramework_FieldType_Base {
    public function _replyToFieldLoader() {
        $this->setUp();
    }
    public function _replyToGetScripts() {
...
class SP_v1_0_6_AdminPageFramework_FieldType_color extends SP_v1_0_6_AdminPageFramework_FieldType {
    ...
    protected function getScripts() {
        ...
        $_sDoubleQuote = '\"';
        return <<<JAVASCRIPTS
registerSP_v1_0_6_AdminPageFrameworkColorPickerField = function( osTragetInput, aOptions ) {
    ...
    jQuery().registerSP_v1_0_6_AdminPageFrameworkCallbacks( {     
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            oCloned.find( 'input.input_color' ).each( function( iIterationIndex ) {
                ...
                registerSP_v1_0_6_AdminPageFrameworkColorPickerField( _oNewColorInput );                
...
jQuery( document ).ready( function(){
    registerSP_v1_0_6_AdminPageFrameworkColorPickerField( '{$sInputID}' );
});            
JAVASCRIPTS;
