...
class SP_v1_0_7_AdminPageFramework_FieldType_checkbox extends SP_v1_0_7_AdminPageFramework_FieldType {
...
JAVASCRIPTS;
    ...
    private function _getEachCheckboxOutput(array $aField, $sKey, $sLabel) {
        ...
        $_oCheckbox = new SP_v1_0_7_AdminPageFramework_Input_checkbox($_aInputAttributes, array('save_unchecked' => $this->getElement($aField, 'save_unchecked'),));
...
class SP_v1_0_7_AdminPageFramework_FieldType_posttype extends SP_v1_0_7_AdminPageFramework_FieldType_checkbox {
