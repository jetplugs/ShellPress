...
class SP_v1_0_8_AdminPageFramework_FieldType_checkbox extends SP_v1_0_8_AdminPageFramework_FieldType {
...
JAVASCRIPTS;
    ...
    private function _getSelectButtonClassSelectors(array $aFieldTypeSlugs, $sDataAttribute = 'select_all_button') {
        ...
        foreach ($aFieldTypeSlugs as $_sSlug) {
            ...
            $_aClassSelectors[] = '.shellpress-checkbox-container-' . $_sSlug . "[data-{$sDataAttribute}]";
        }
        return implode(',', $_aClassSelectors);
    }
    protected function getStyles() {
        return ".select_all_button_container, .select_none_button_container{display: inline-block;margin-bottom: 0.4em;}.shellpress-checkbox-label {margin-top: 0.1em;}.shellpress-field input[type='checkbox' ] {margin-right: 0.5em;} .shellpress-field-checkbox .shellpress-input-label-container {padding-right: 1em;}.shellpress-field-checkbox .shellpress-input-label-string{display: inline; }";
    }
...
class SP_v1_0_8_AdminPageFramework_FieldType_posttype extends SP_v1_0_8_AdminPageFramework_FieldType_checkbox {
    ...
    protected function getStyles() {
        ...
        return $_sParentStyles . ".shellpress-field input[type='checkbox'] {margin-right: 0.5em;} .shellpress-field-posttype .shellpress-input-label-container {padding-right: 1em;}";
    }
    protected function getField($aField) {
