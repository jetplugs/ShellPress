...
class SP_v1_0_7_AdminPageFramework_FieldType_import extends SP_v1_0_7_AdminPageFramework_FieldType_submit {
    ...
    protected function getStyles() {
        return ".shellpress-field-import input {margin-right: 0.5em;}.shellpress-field-import label,.form-table td fieldset.shellpress-fieldset .shellpress-field-import label { display: inline; }";
    }
