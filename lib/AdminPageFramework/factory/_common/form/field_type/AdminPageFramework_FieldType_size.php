...
class SP_v1_0_7_AdminPageFramework_FieldType_select extends SP_v1_0_7_AdminPageFramework_FieldType {
    ...
    protected function getField($aField) {
        $_oSelectInput = new SP_v1_0_7_AdminPageFramework_Input_select($aField['attributes']);
...
class SP_v1_0_7_AdminPageFramework_FieldType_size extends SP_v1_0_7_AdminPageFramework_FieldType_select {
    ...
    private function _getUnitSelectInput(array $aField, array $aBaseAttributes, $isKey, $bMultiLabels) {
        ...
        $_oUnitInput = new SP_v1_0_7_AdminPageFramework_Input_select($_aUnitAttributes + array('select' => $_aUnitAttributes));
