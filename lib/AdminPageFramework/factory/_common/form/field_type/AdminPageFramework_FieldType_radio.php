...
class SP_v1_0_6_AdminPageFramework_FieldType_radio extends SP_v1_0_6_AdminPageFramework_FieldType {
    public $aFieldTypeSlugs = array('radio');
    protected $aDefaultKeys = array('label' => array(), 'attributes' => array(),);
    protected function getStyles() {
        return ".shellpress-field input[type='radio'] {margin-right: 0.5em;} .shellpress-field-radio .shellpress-input-label-container {padding-right: 1em;} .shellpress-field-radio .shellpress-input-container {display: inline;} .shellpress-field-radio .shellpress-input-label-string{display: inline; }";
    }
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.shellpress-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).attr( 'checked', false );
