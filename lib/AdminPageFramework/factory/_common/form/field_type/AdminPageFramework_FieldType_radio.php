...
class SP_v1_0_8_AdminPageFramework_FieldType_radio extends SP_v1_0_8_AdminPageFramework_FieldType {
    ...
    private function _getEachRadioButtonOutput(array $aField, $sKey, $sLabel) {
        ...
        $_oRadio = new SP_v1_0_8_AdminPageFramework_Input_radio($_aAttributes);
