...
class SP_v1_0_8_AdminPageFramework_Message {
    ...
    public static function getInstance($sTextDomain = 'shellpress') {
        $_oInstance = isset(self::$_aInstancesByTextDomain[$sTextDomain]) && (self::$_aInstancesByTextDomain[$sTextDomain] instanceof SP_v1_0_8_AdminPageFramework_Message) ? self::$_aInstancesByTextDomain[$sTextDomain] : new SP_v1_0_8_AdminPageFramework_Message($sTextDomain);
