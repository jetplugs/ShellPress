...
class SP_v1_0_6_AdminPageFramework_Message {
    ...
    public static function getInstance($sTextDomain = 'shellpress') {
        $_oInstance = isset(self::$_aInstancesByTextDomain[$sTextDomain]) && (self::$_aInstancesByTextDomain[$sTextDomain] instanceof SP_v1_0_6_AdminPageFramework_Message) ? self::$_aInstancesByTextDomain[$sTextDomain] : new SP_v1_0_6_AdminPageFramework_Message($sTextDomain);
    ...
    private function __doDummy() {
        ...
        __('Export Options', 'shellpress');
        __('Import', 'shellpress');
        __('Import Options', 'shellpress');
