...
abstract class SP_v1_0_6_AdminPageFramework_Property_Base extends SP_v1_0_6_AdminPageFramework_FrameworkUtility {
    ...
    private function ___setGlobals() {
        if (!isset($GLOBALS['aSP_v1_0_6_AdminPageFramework'])) {
            $GLOBALS['aSP_v1_0_6_AdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => SP_v1_0_6_AdminPageFramework_Registry::NAME, 'sURI' => SP_v1_0_6_AdminPageFramework_Registry::URI, 'sScriptName' => SP_v1_0_6_AdminPageFramework_Registry::NAME, 'sLibraryName' => SP_v1_0_6_AdminPageFramework_Registry::NAME, 'sLibraryURI' => SP_v1_0_6_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => SP_v1_0_6_AdminPageFramework_Registry::getVersion(), 'sDescription' => SP_v1_0_6_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => SP_v1_0_6_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => SP_v1_0_6_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => SP_v1_0_6_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => SP_v1_0_6_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new SP_v1_0_6_AdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
}
