...
abstract class SP_v1_0_8_AdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array('oForm' => 'SP_v1_0_8_AdminPageFramework_Form_', 'oPageLoadInfo' => 'SP_v1_0_8_AdminPageFramework_PageLoadInfo_', 'oResource' => 'SP_v1_0_8_AdminPageFramework_Resource_', 'oHelpPane' => 'SP_v1_0_8_AdminPageFramework_HelpPane_', 'oLink' => 'SP_v1_0_8_AdminPageFramework_Link_',);
    private $_aSubClassNames = array('oProp' => null, 'oDebug' => 'SP_v1_0_8_AdminPageFramework_Debug', 'oUtil' => 'SP_v1_0_8_AdminPageFramework_FrameworkUtility', 'oMsg' => 'SP_v1_0_8_AdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null,);
    ...
    private function _triggerUndefinedMethodWarning($sMethodName) {
        trigger_error(SP_v1_0_8_AdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
    public function __toString() {
        return SP_v1_0_8_AdminPageFramework_FrameworkUtility::getObjectInfo($this);
    }
...
abstract class SP_v1_0_8_AdminPageFramework_Factory_Model extends SP_v1_0_8_AdminPageFramework_Factory_Router {
    public function __construct($oProp) {
...
abstract class SP_v1_0_8_AdminPageFramework_Factory_View extends SP_v1_0_8_AdminPageFramework_Factory_Model {
    public function __construct($oProp) {
        parent::__construct($oProp);
        new SP_v1_0_8_AdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
    }
...
abstract class SP_v1_0_8_AdminPageFramework_Factory_Controller extends SP_v1_0_8_AdminPageFramework_Factory_View {
...
abstract class SP_v1_0_8_AdminPageFramework_Factory extends SP_v1_0_8_AdminPageFramework_Factory_Controller {
}
