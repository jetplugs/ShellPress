...
abstract class SP_v1_0_7_AdminPageFramework_NetworkAdmin extends SP_v1_0_7_AdminPageFramework {
    ...
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_network', $sTextDomain = 'shellpress') {
        ...
        $sCallerPath = $sCallerPath ? $sCallerPath : SP_v1_0_7_AdminPageFramework_Utility::getCallerScriptPath(__FILE__);
        parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
        new SP_v1_0_7_AdminPageFramework_Model_Menu__RegisterMenu($this, 'network_admin_menu');
    }
    ...
    static public function getOption($sOptionKey, $asKey = null, $vDefault = null) {
        return SP_v1_0_7_AdminPageFramework_WPUtility::getSiteOption($sOptionKey, $asKey, $vDefault);
    }
}
