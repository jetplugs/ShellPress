...
abstract class SP_v1_0_6_AdminPageFramework_PostType_Router extends SP_v1_0_6_AdminPageFramework_Factory {
...
abstract class SP_v1_0_6_AdminPageFramework_PostType_Model extends SP_v1_0_6_AdminPageFramework_PostType_Router {
    public function __construct($oProp) {
        parent::__construct($oProp);
        ...
        if ($this->oProp->bIsAdmin) {
            ...
            if ($this->oProp->sCallerPath) {
                new SP_v1_0_6_AdminPageFramework_PostType_Model__FlushRewriteRules($this);
            }
        }
    }
    ...
    public function _replyToRegisterPostType() {
        ...
        new SP_v1_0_6_AdminPageFramework_PostType_Model__SubMenuOrder($this);
    }
...
abstract class SP_v1_0_6_AdminPageFramework_PostType_View extends SP_v1_0_6_AdminPageFramework_PostType_Model {
    public function __construct($oProp) {
        parent::__construct($oProp);
        if ($this->oProp->bIsAdmin) {
    ...
    public function _replyToPrintStyle() {
        ...
        if (!empty($this->oProp->sStyle)) {
            echo "<style type='text/css' id='shellpress-style-post-type'>" . $this->oProp->sStyle . "</style>";
        }
    }
...
abstract class SP_v1_0_6_AdminPageFramework_PostType_Controller extends SP_v1_0_6_AdminPageFramework_PostType_View {
...
abstract class SP_v1_0_6_AdminPageFramework_PostType extends SP_v1_0_6_AdminPageFramework_PostType_Controller {
    protected $_sStructureType = 'post_type';
    public function __construct($sPostType, $aArguments = array(), $sCallerPath = null, $sTextDomain = 'shellpress') {
        if (empty($sPostType)) {
            return;
        }
        ...
        $this->oProp->sPostType = SP_v1_0_6_AdminPageFramework_WPUtility::sanitizeSlug($sPostType);
        $this->oProp->aPostTypeArgs = $aArguments;
    ...
    private function _getCallerScriptPath($sCallerPath) {
        ...
        $_sPageNow = SP_v1_0_6_AdminPageFramework_Utility::getElement($GLOBALS, 'pagenow');
        if (in_array($_sPageNow, array('edit.php', 'post.php', 'post-new.php', 'plugins.php', 'tags.php', 'edit-tags.php', 'term.php'))) {
            return SP_v1_0_6_AdminPageFramework_Utility::getCallerScriptPath(__FILE__);
        }
        return null;
    }
}
