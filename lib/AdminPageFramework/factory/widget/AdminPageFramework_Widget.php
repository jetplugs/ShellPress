...
abstract class SP_v1_0_6_AdminPageFramework_Widget_Router extends SP_v1_0_6_AdminPageFramework_Factory {
...
abstract class SP_v1_0_6_AdminPageFramework_Widget_Model extends SP_v1_0_6_AdminPageFramework_Widget_Router {
    ...
    public function _replyToRegisterWidget() {
        ...
        $wp_widget_factory->widgets[$this->oProp->sClassName] = new SP_v1_0_6_AdminPageFramework_Widget_Factory($this, $this->oProp->sWidgetTitle, $this->oUtil->getAsArray($this->oProp->aWidgetArguments));
        $this->oProp->oWidget = $wp_widget_factory->widgets[$this->oProp->sClassName];
    }
}
abstract class SP_v1_0_6_AdminPageFramework_Widget_View extends SP_v1_0_6_AdminPageFramework_Widget_Model {
...
abstract class SP_v1_0_6_AdminPageFramework_Widget_Controller extends SP_v1_0_6_AdminPageFramework_Widget_View {
...
abstract class SP_v1_0_6_AdminPageFramework_Widget extends SP_v1_0_6_AdminPageFramework_Widget_Controller {
    protected $_sStructureType = 'widget';
    public function __construct($sWidgetTitle, $aWidgetArguments = array(), $sCapability = 'edit_theme_options', $sTextDomain = 'shellpress') {
