...
class SP_v1_0_8_AdminPageFramework_Property_widget extends SP_v1_0_8_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'shellpress', $sStructureType) {
