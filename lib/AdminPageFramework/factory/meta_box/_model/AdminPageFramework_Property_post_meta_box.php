...
class SP_v1_0_7_AdminPageFramework_Property_post_meta_box extends SP_v1_0_7_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'edit_posts', $sTextDomain = 'shellpress', $sStructureType = 'post_meta_box') {
