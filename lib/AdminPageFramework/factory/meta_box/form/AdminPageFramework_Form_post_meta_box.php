...
class SP_v1_0_7_AdminPageFramework_Form_post_meta_box extends SP_v1_0_7_AdminPageFramework_Form_Meta {
    public $sStructureType = 'post_meta_box';
    public function construct() {
        $this->_addDefaultResources();
    }
    private function _addDefaultResources() {
        $_oCSS = new SP_v1_0_7_AdminPageFramework_Form_View___CSS_meta_box;
