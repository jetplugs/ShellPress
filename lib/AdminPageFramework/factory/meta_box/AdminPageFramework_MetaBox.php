...
abstract class SP_v1_0_8_AdminPageFramework_MetaBox_Router extends SP_v1_0_8_AdminPageFramework_Factory {
...
abstract class SP_v1_0_8_AdminPageFramework_MetaBox_Model extends SP_v1_0_8_AdminPageFramework_MetaBox_Router {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'shellpress') {
    ...
    public function _replyToGetSavedFormData() {
        $_oMetaData = new SP_v1_0_8_AdminPageFramework_MetaBox_Model___PostMeta($this->_getPostID(), $this->oForm->aFieldsets);
...
abstract class SP_v1_0_8_AdminPageFramework_MetaBox_View extends SP_v1_0_8_AdminPageFramework_MetaBox_Model {
...
abstract class SP_v1_0_8_AdminPageFramework_MetaBox_Controller extends SP_v1_0_8_AdminPageFramework_MetaBox_View {
...
abstract class SP_v1_0_8_AdminPageFramework_MetaBox extends SP_v1_0_8_AdminPageFramework_MetaBox_Controller {
