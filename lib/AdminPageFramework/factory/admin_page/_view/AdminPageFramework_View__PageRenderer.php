...
class SP_v1_0_8_AdminPageFramework_View__PageRenderer extends SP_v1_0_8_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    public $sPageSlug;
    public $sTabSlug;
    ...
    private function _getContentTop() {
        $_oScreenIcon = new SP_v1_0_8_AdminPageFramework_View__PageRenderer__ScreenIcon($this->oFactory, $this->sPageSlug, $this->sTabSlug);
        $_sContentTop = $_oScreenIcon->get();
        $_oPageHeadingTabs = new SP_v1_0_8_AdminPageFramework_View__PageRenderer__PageHeadingTabs($this->oFactory, $this->sPageSlug);
        $_sContentTop.= $_oPageHeadingTabs->get();
        $_oInPageTabs = new SP_v1_0_8_AdminPageFramework_View__PageRenderer__InPageTabs($this->oFactory, $this->sPageSlug);
    ...
    private function _printPageMetaBoxes() {
        $_oPageMetaBoxRenderer = new SP_v1_0_8_AdminPageFramework_View__PageMataBoxRenderer();
