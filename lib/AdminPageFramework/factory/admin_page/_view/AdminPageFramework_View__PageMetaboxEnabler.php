...
class SP_v1_0_8_AdminPageFramework_View__PageMetaboxEnabler extends SP_v1_0_8_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    private function _isMetaBoxAdded() {
        $_aPageMetaBoxClasses = $this->getElementAsArray($GLOBALS, array('aSP_v1_0_8_AdminPageFramework', 'aMetaBoxForPagesClasses'));
    ...
    public function _replyToAddMetaboxScript() {
        $_bLoaded = $this->getElement($GLOBALS, array('aSP_v1_0_8_AdminPageFramework', 'bAddedMetaBoxScript'), false);
        if ($_bLoaded) {
            return;
        }
        $GLOBALS['aSP_v1_0_8_AdminPageFramework']['bAddedMetaBoxScript'] = true;
