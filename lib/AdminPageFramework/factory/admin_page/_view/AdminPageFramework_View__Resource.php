...
class SP_v1_0_8_AdminPageFramework_View__Resource extends SP_v1_0_8_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    private function _enqueueAsset_style($asPageStyle) {
        $_oFormatter = new SP_v1_0_8_AdminPageFramework_Format_PageResource_Style($asPageStyle);
    ...
    private function _enqueueAsset_script($asPageScript) {
        $_oFormatter = new SP_v1_0_8_AdminPageFramework_Format_PageResource_Script($asPageScript);
