...
class SP_v1_0_7_AdminPageFramework_PageLoadInfo_admin_page extends SP_v1_0_7_AdminPageFramework_PageLoadInfo_Base {
    ...
    public static function instantiate($oProp, $oMsg) {
        ...
        self::$_oInstance = new SP_v1_0_7_AdminPageFramework_PageLoadInfo_admin_page($oProp, $oMsg);
        return self::$_oInstance;
    }
