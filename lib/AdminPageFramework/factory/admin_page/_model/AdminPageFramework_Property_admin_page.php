...
class SP_v1_0_7_AdminPageFramework_Property_admin_page extends SP_v1_0_7_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'shellpress') {
        ...
        $GLOBALS['aSP_v1_0_7_AdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('aSP_v1_0_7_AdminPageFramework', 'aPageClasses'));
        $GLOBALS['aSP_v1_0_7_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
