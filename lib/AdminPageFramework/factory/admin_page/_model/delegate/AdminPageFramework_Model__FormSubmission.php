...
abstract class SP_v1_0_8_AdminPageFramework_Model__FormSubmission_Base extends SP_v1_0_8_AdminPageFramework_FrameworkUtility {
...
class SP_v1_0_8_AdminPageFramework_Model__FormSubmission extends SP_v1_0_8_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
        $this->oFactory = $oFactory;
        $this->_handleFormData();
        new SP_v1_0_8_AdminPageFramework_Model__FormRedirectHandler($oFactory);
    }
    public function _handleFormData() {
        ...
        new SP_v1_0_8_AdminPageFramework_Model__FormSubmission__Validator($this->oFactory);
