...
class SP_v1_0_8_AdminPageFramework_Model__FormSubmission__Validator__Import extends SP_v1_0_8_AdminPageFramework_Model__FormSubmission__Validator_Base {
    ...
    private function _importOptions($aStoredOptions, $sPageSlug, $sTabSlug) {
        $_oImport = new SP_v1_0_8_AdminPageFramework_ImportOptions($_FILES['__import'], $_POST['__import']);
...
class SP_v1_0_8_AdminPageFramework_Model__FormSubmission__Validator__Export extends SP_v1_0_8_AdminPageFramework_Model__FormSubmission__Validator__Import {
    public $sActionHookPrefix = 'try_validation_after_';
    ...
    protected function _exportOptions($mData, $sPageSlug, $sTabSlug) {
        $_oExport = new SP_v1_0_8_AdminPageFramework_ExportOptions($_POST['__export'], $this->oFactory->oProp->sClassName);
