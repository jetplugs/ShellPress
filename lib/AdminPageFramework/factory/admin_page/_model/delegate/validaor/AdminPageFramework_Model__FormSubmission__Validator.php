...
class SP_v1_0_6_AdminPageFramework_Model__FormSubmission__Validator_Base extends SP_v1_0_6_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
...
class SP_v1_0_6_AdminPageFramework_Model__FormSubmission__Validator extends SP_v1_0_6_AdminPageFramework_Model__FormSubmission__Validator_Base {
    public $oFactory;
    ...
    public function _replyToValiateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
        ...
        $_aClassNames = array('SP_v1_0_6_AdminPageFramework_Model__FormSubmission__Validator__Link', 'SP_v1_0_6_AdminPageFramework_Model__FormSubmission__Validator__Redirect', 'SP_v1_0_6_AdminPageFramework_Model__FormSubmission__Validator__Import', 'SP_v1_0_6_AdminPageFramework_Model__FormSubmission__Validator__Export', 'SP_v1_0_6_AdminPageFramework_Model__FormSubmission__Validator__Reset', 'SP_v1_0_6_AdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'SP_v1_0_6_AdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'SP_v1_0_6_AdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
        ...
        try {
            ...
            $_oFormSubmissionFilter = new SP_v1_0_6_AdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
