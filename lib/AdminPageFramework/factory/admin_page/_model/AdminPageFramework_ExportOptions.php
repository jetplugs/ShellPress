...
abstract class SP_v1_0_7_AdminPageFramework_CustomSubmitFields extends SP_v1_0_7_AdminPageFramework_FrameworkUtility {
    public $aPost = array();
    public $sInputID;
...
class SP_v1_0_7_AdminPageFramework_ExportOptions extends SP_v1_0_7_AdminPageFramework_CustomSubmitFields {
    public $sClassName;
    public $sFileName;
    public $sFormatType;
    public $bIsDataSet;
        ...
        switch (strtolower($sFormatType)) {
            case 'text':
                if (in_array(gettype($vData), array('array', 'object'))) {
                    echo SP_v1_0_7_AdminPageFramework_Debug::get($vData, null, false);
                }
                echo $vData;
                return;
            case 'json':
