...
class SP_v1_0_7_AdminPageFramework_Form_taxonomy_field extends SP_v1_0_7_AdminPageFramework_Form {
    ...
    public function get() {
        ...
        $_oFieldsets = new SP_v1_0_7_AdminPageFramework_Form_View___FieldsetRows($this->getElementAsArray($this->aFieldsets, '_default'), null, $this->aSavedData, $this->getFieldErrors(), $this->aFieldTypeDefinitions, $this->aCallbacks, $this->oMsg);
