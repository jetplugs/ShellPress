...
abstract class SP_v1_0_8_AdminPageFramework_TermMeta_Router extends SP_v1_0_8_AdminPageFramework_TaxonomyField_Controller {
}
abstract class SP_v1_0_8_AdminPageFramework_TermMeta_Model extends SP_v1_0_8_AdminPageFramework_TermMeta_Router {
    ...
    private function _getSavedTermMetas($iTermID, array $aFieldsets) {
        $_oMetaData = new SP_v1_0_8_AdminPageFramework_TermMeta_Model___TermMeta($iTermID, $this->oForm->aFieldsets);
...
abstract class SP_v1_0_8_AdminPageFramework_TermMeta_View extends SP_v1_0_8_AdminPageFramework_TermMeta_Model {
...
abstract class SP_v1_0_8_AdminPageFramework_TermMeta_Controller extends SP_v1_0_8_AdminPageFramework_TermMeta_View {
}
abstract class SP_v1_0_8_AdminPageFramework_TermMeta extends SP_v1_0_8_AdminPageFramework_TermMeta_Controller {
    protected $_sStructureType = 'term_meta';
    public function __construct($asTaxonomySlug, $sCapability = 'manage_options', $sTextDomain = 'shellpress') {
