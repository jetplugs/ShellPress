...
class SP_v1_0_6_AdminPageFramework_Property_page_meta_box extends SP_v1_0_6_AdminPageFramework_Property_post_meta_box {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'shellpress', $sStructureType = 'page_meta_box') {
        ...
        $GLOBALS['aSP_v1_0_6_AdminPageFramework']['aMetaBoxForPagesClasses'] = $this->getElementAsArray($GLOBALS, array('aSP_v1_0_6_AdminPageFramework', 'aMetaBoxForPagesClasses'));
        $GLOBALS['aSP_v1_0_6_AdminPageFramework']['aMetaBoxForPagesClasses'][$sClassName] = $oCaller;
    }
    ...
    private function _getOwnerObjectOfPage($sPageSlug) {
        $_aPageClasses = $this->getElementAsArray($GLOBALS, array('aSP_v1_0_6_AdminPageFramework', 'aPageClasses'));
