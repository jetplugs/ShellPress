...
abstract class SP_v1_0_7_AdminPageFramework_UserMeta_Router extends SP_v1_0_7_AdminPageFramework_Factory {
...
abstract class SP_v1_0_7_AdminPageFramework_UserMeta_Model extends SP_v1_0_7_AdminPageFramework_UserMeta_Router {
    public function _replyToGetSavedFormData() {
        $_iUserID = isset($GLOBALS['profileuser']->ID) ? $GLOBALS['profileuser']->ID : 0;
        $_oMetaData = new SP_v1_0_7_AdminPageFramework_UserMeta_Model___UserMeta($_iUserID, $this->oForm->aFieldsets);
...
abstract class SP_v1_0_7_AdminPageFramework_UserMeta_View extends SP_v1_0_7_AdminPageFramework_UserMeta_Model {
...
abstract class SP_v1_0_7_AdminPageFramework_UserMeta_Controller extends SP_v1_0_7_AdminPageFramework_UserMeta_View {
...
abstract class SP_v1_0_7_AdminPageFramework_UserMeta extends SP_v1_0_7_AdminPageFramework_UserMeta_Controller {
    protected $_sStructureType = 'user_meta';
    public function __construct($sCapability = 'read', $sTextDomain = 'shellpress') {
